...
class emailSender():
    def __init__(self):
        self.myEmail = 'no-reply@noosphere.net'
        self.username = 'no-reply@noosphere.net'
    ...
    def sendEmailConfirm(self, email):
        ...
        <html>
            <head style = 'border:solid 1px maroon;'>
                ...
                <h3>This e-mail address was specified as a contact on the portal pvm.noosphere.net in the "Registration" section. To confirm, click on the link below.</h3>
            </head>
        <body>
...
class FlaskWorker():
    def __init__(self):
        ...
        self.mongo_conn.drop_database(self.mongo)  # CLEAR MONGODB NOOSPHERE DATABASE
        ...
        def createShard():
            ...
            if os.path.exists(way):
                ...
                data = json.dumps({"STATUS": False, "DESCR": "INTERNAL ERROR, NOT FOUND NOOCRYPTO SCRIPT"}, separators=(',', ':'))
                return data
